...
export type SportsMealsSection = {
  ...
  contextualLinks?: readonly SportsMealsLink[]
}
    ...
    },
    {
      ...
      contextualLinks: [
        ...
        },
        {
          ...
          label: 'construire un exemple de menu pour une perte de poids progressive',
          description: 'Composer une journée rassasiante avec des variantes pratiques.',
        },
      ],
    },
    {
