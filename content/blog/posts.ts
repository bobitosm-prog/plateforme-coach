        ...
        relatedLinks: [
          {
            ...
            label: 'Calculer vos besoins en calories et macros',
          },
          {
        ...
        relatedLinks: [
          {
            ...
            label: 'Créer un programme selon votre volume d’entraînement',
          },
        ],
    ...
    content: {
      fr: {
        ...
        relatedLinks: [
          {
            href: '/fr/coach-sportif-ia',
            label: 'Adapter un programme à vos disponibilités',
          },
        ],
        ...
        relatedLinks: [
          {
            ...
            label: 'Consulter le guide complet de musculation',
          },
        ],
