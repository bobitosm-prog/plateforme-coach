...
Traiter uniquement C04, le graphe Nutrition desktop sept jours identifié dans
l'[audit de clôture Nutrition read-only](NUTRITION_READ_ONLY_CLOSURE_AUDIT.md),
sans rouvrir C03 ni les surfaces Home figées. C01, C02, C03 et C09 distinguent
