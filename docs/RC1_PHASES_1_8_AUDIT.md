...
Traiter uniquement C07, le badge `macros_on_target`
identifié dans
l'[audit de clôture Nutrition read-only](NUTRITION_READ_ONLY_CLOSURE_AUDIT.md),
sans rouvrir C03/C04/C05/C06 ni les surfaces Home figées. C01, C02, C03, C04, C05, C06 et C09 distinguent
