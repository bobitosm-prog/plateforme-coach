...
Traiter uniquement C05, les macros et objectifs rendus par `NutritionTab`
identifiés dans
l'[audit de clôture Nutrition read-only](NUTRITION_READ_ONLY_CLOSURE_AUDIT.md),
sans rouvrir C03/C04 ni les surfaces Home figées. C01, C02, C03, C04 et C09 distinguent
