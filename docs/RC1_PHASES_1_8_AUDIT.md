...
Traiter uniquement C06, la lecture du sous-onglet « Mes repas » de `NutritionTab`
identifiés dans
l'[audit de clôture Nutrition read-only](NUTRITION_READ_ONLY_CLOSURE_AUDIT.md),
sans rouvrir C03/C04/C05 ni les surfaces Home figées. C01, C02, C03, C04, C05 et C09 distinguent
