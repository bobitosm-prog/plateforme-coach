...
import CoachSectionFallback from './sections/CoachSectionFallback'
import type { CoachTranslator } from './sections/coach-page-types'

const CoachDesktopLayout = dynamic(() => import('./sections/CoachDesktopLayout'), { loading: CoachSectionFallback })
const CoachMobileLayout = dynamic(() => import('./sections/CoachMobileLayout'), { loading: CoachSectionFallback })

export type CoachPageContentProps = {
  initialSession?: Session | null
}

export default function CoachPageContent({ initialSession }: CoachPageContentProps = {}) {
  return <ClientIntlProvider><CoachPageContentInner initialSession={initialSession} /></ClientIntlProvider>
}

function CoachPageContentInner({ initialSession }: CoachPageContentProps) {
