...
export default function NotFound() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: BG_BASE, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '2rem', textAlign: 'center', fontFamily: FONT_BODY }}>
      ...
      <button onClick={() => router.push('/')} style={{ padding: '14px 32px', borderRadius: 0, border: 'none', background: GOLD, color: BG_BASE, fontSize: '0.95rem', fontFamily: FONT_ALT, fontWeight: 800, cursor: 'pointer', letterSpacing: '1px', clipPath: 'polygon(0 0,100% 0,96% 100%,0 100%)' }}>Retour a l'accueil</button>
    </div>
  )
}
