      ...
      <div className="card" style={{position:'relative',overflow:'hidden',padding:'16px 16px 14px'}}>
        ...
        <div style={{display:'flex',alignItems:'center',gap:12,marginTop:4}}>
          <div style={{position:'relative',flexShrink:0}}>
            <div style={{width:60,height:60,borderRadius:'50%',background:'linear-gradient(135deg,#D4A843,#E8C97A)',display:'flex',alignItems:'center',justifyContent:'center',fontFamily:"'Barlow Condensed',sans-serif",fontSize:'1.3rem',fontWeight:700,color:'#fff',border:'3px solid #141414',boxShadow:'0 0 0 2px #D4A843'}}>
              {initials(profile.full_name)}
            </div>
            <div style={{position:'absolute',bottom:2,right:2,width:12,height:12,background:'#D4A843',borderRadius:'50%',border:'2px solid #141414'}}/>
          </div>
