  ...
  return (
    <>
      ...
      <div style={{ background: '#050505', minHeight: '100vh', color: '#f8fafc' }}>
        ...
        <div ref={pwaRev.ref}>
          <Section>
            <SectionTitle title="INSTALLE MOOVX EN 30 SECONDES" subtitle="Pas besoin d'App Store ni de Google Play. Installe directement depuis ton navigateur." visible={pwaRev.visible} />
