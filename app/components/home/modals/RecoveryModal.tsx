...
const ZONE_SHAPES: readonly ZoneShape[] = [
  ...
  { zone: 'quadriceps', side: 'front', paths: ['M171 590 C190 577 222 580 244 600 C259 622 264 668 257 714 C251 756 236 789 216 801 C197 808 180 790 169 760 C155 713 153 630 171 590 Z', 'M298 612 C303 655 306 712 298 757 C291 790 278 810 263 814 C248 805 241 786 245 766 C258 735 263 701 251 668 C266 652 284 634 298 612 Z', 'M340 612 C354 634 372 652 387 668 C375 701 380 735 393 766 C397 786 390 805 375 814 C360 810 347 790 340 757 C332 712 335 655 340 612 Z', 'M394 600 C416 580 448 577 467 590 C485 630 483 713 469 760 C458 790 441 808 422 801 C402 789 387 756 381 714 C374 668 379 622 394 600 Z'] },
      ...
      <svg className={styles.bodyOverlay} viewBox="0 0 611 1286" aria-label={t('mapLabel', { side: t(`side.${side}`) })}>
        {ZONE_SHAPES.filter(shape => shape.side === side).map(shape => {
          ...
          >
            ...
            {shape.paths.map(path => <path key={path} className={styles.hitArea} d={path} />)}
