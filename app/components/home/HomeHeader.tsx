...
export default function HomeHeader({
  firstName, displayAvatar, level, levelTitle, streak,
  xpInLevel, xpForNext, xpProgress, onLevelClick,
}: HomeHeaderProps) {
  const t = useTranslations('home.header')
  return (
    <div style={{ ...cardStyle, margin: '0 16px', padding: '16px 20px' }}>
      <div style={{
        display: 'flex',
        justifyContent: 'space-between',
        alignItems: 'center',
      }}>
        {/* Left — Avatar + Name + Level + XP */}
        <button
        ...
        >
          ...
          <div>
            ...
            <div style={{
              ...
              {t('level', { level })} · {levelTitle} <span style={{ opacity: 0.5 }}>&rsaquo;</span>
            </div>
            <div style={{ marginTop: 6 }}>
              <div style={{ ...xpBarTrackStyle, width: 140 }}>
                <div style={{ ...xpBarFillStyle, width: `${xpProgress * 100}%` }} />
              </div>
              <div style={{ fontFamily: FONT_ALT, fontSize: 9, fontWeight: 700, letterSpacing: '0.1em', color: TEXT_DIM, marginTop: 3 }}>
