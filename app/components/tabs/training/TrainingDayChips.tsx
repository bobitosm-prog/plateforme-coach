'use client'
import {
  WEEK_DAYS, GOLD, GOLD_RULE, BORDER, TEXT_MUTED, FONT_ALT, JS_DAYS_FR, colors,
        ...
        {WEEK_DAYS.map((day, idx) => {
          ...
          return (
            <button key={day} onClick={() => onSelectDay(day)} style={{
              ...
              <span style={{ fontFamily: FONT_ALT, fontSize: 13, fontWeight: 700, color: isActive ? colors.onGold : isToday ? GOLD : TEXT_MUTED, textTransform: 'capitalize' }}>
                {day.slice(0, 3)}
              </span>
