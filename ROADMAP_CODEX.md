...
**Statut : checklist terminée — 16 tâches sur 16 ; définition de terminé partielle en audit RC1 : production et réutilisation de `saved_meals` sont versionnées et fail-closed ; les producteurs de plans sont caractérisés mais non migrables avant alignement du schéma, et deux cas historiques pleinement comparables restent divergents**
