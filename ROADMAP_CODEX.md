...
| Tâche | Estimation | Difficulté | Risque | Impact | Dépend de |
|---|---:|---|---|---|---|
| [ ] Étendre la suite à 15 parcours E2E critiques — en cours : 7/15 parcours intégrés; seul « Parcours client rattaché à un coach » est ajouté dans ce sous-batch, le parcours coach reste planifié | 4 j | Élevée | Moyen | Critique | Domaines stabilisés |
