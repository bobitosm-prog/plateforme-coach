...
**Statut : checklist terminée — 16 tâches sur 16 ; définition de terminé partielle en audit RC1 : production et réutilisation de `saved_meals` sont versionnées et fail-closed ; l'ADR 0007 et sa frontière read-only fixent la cible des plans sans migrer les producteurs ou consommateurs, et deux cas historiques pleinement comparables restent divergents**
