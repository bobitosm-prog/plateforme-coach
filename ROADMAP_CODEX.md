...
| Tâche | Estimation | Difficulté | Risque | Impact | Dépend de |
|---|---:|---|---|---|---|
| [ ] Étendre la suite à 15 parcours E2E critiques — en cours : 13/15 parcours intégrés; seul « Suivi de progression » est ajouté dans ce sous-batch, Realtime/Messagerie reste planifié | 4 j | Élevée | Moyen | Critique | Domaines stabilisés |
