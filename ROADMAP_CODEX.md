...
| Tâche | Estimation | Difficulté | Risque | Impact | Dépend de |
|---|---:|---|---|---|---|
| [ ] Étendre la suite à 15 parcours E2E critiques — en cours : 12/15 parcours intégrés; seul « Journal nutritionnel quotidien » est ajouté dans ce sous-batch, le suivi de progression reste planifié | 4 j | Élevée | Moyen | Critique | Domaines stabilisés |
