...
**Statut : Phase 3 ouverte — 13 tâches sur 27 ; historique et séances récentes extraits sans fusion des deux historiques legacy, prochaine tranche : modales de `TrainingTab`**
...
|---|---:|---:|---:|---:|---|
| Progression globale de la roadmap | 0 % | 50 % | 100 % | ≈41 % (56/138 tâches) | 🟠 |
...
| Tests unitaires | 93 | ≥160 | ≥250 | 809 actifs + 3 contractuels `todo` | 🟢 |
