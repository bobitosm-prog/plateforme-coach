...
**Statut : checklist terminée — 16 tâches sur 16 ; définition de terminé partielle en audit RC1 : production et réutilisation de `saved_meals` sont versionnées et fail-closed ; l'ADR 0007 et sa frontière read-only fixent la cible des plans, cinq lectures runtime dont les deux du détail client coach sont raccordées sans écriture, et deux cas historiques pleinement comparables restent divergents**
