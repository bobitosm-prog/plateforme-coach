...
export const LOAD_MODES = ['barbell_total', 'total', 'two_dumbbells', 'one_dumbbell', 'unilateral_both', 'external_only', 'band', 'legacy'] as const
...
export function setTonnage(set: {weight?: unknown; reps?: unknown; completed?: boolean | null; done?: boolean; duration_seconds?: unknown; durationSeconds?: unknown; load_mode?: unknown; loadMode?: unknown}): number {
  ...
  if (mode === 'band') return 0 // band resistance is not a constant lifted mass
