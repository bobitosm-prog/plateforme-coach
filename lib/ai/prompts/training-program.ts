...
export function buildTrainingProgramInvocation(input: {
  objective: string; level: string; daysPerWeek: number; duration: number; equipment: string
  priorities: readonly string[]; notes: string; gender: string
}, catalog: readonly { id: string; name: string }[] = []): AiPromptInvocation {
