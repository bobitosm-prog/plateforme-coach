...
function setup(initialFoods:any[]=[],photoEnabled=false) {
  ...
  render(React.createElement(React.StrictMode,null,React.createElement(MealComposer,{supabase,userId:'owner',date:'2026-09-20',mealType:'diner',mealLabel:'Dinner',plannedFoods:[food],initialFoods,photoEnabled,onSaved,onClose})))
  return {upsert,onSaved,onClose}
}
